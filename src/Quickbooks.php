...
class Quickbooks extends \QuickBooks_IPP_Service
{
    ...
    protected function handleTransactionData($data, $obj)
    {
        ...
        isset($data['Balance']) ? $obj->setBalance($data['Balance']) : '';
        isset($data['ARAccountRef']) ? $obj->setARAccountRef($data['ARAccountRef']) : '';
        isset($data['BreakHours']) ? $obj->setBreakHours($data['BreakHours']) : '';
        isset($data['BreakMinutes']) ? $obj->setBreakMinutes($data['BreakMinutes']) : '';
        ...
        isset($data['EmployeeRef']) ? $obj->setEmployeeRef($data['EmployeeRef']) : '';
        isset($data['EndTime']) ? $obj->setEndTime($data['EndTime']) : '';
        ...
        isset($data['FromAccountRef']) ? $obj->setFromAccountRef($data['FromAccountRef']) : '';
        ...
        isset($data['HourlyRate']) ? $obj->setHourlyRate($data['HourlyRate']) : '';
        isset($data['Hours']) ? $obj->setHours($data['Hours']) : '';
        isset($data['ItemRef']) ? $obj->setItemRef($data['ItemRef']) : '';
        isset($data['Memo']) ? $obj->setMemo($data['Memo']) : '';
        isset($data['Minutes']) ? $obj->setMinutes($data['Minutes']) : '';
        isset($data['NameOf']) ? $obj->setNameOf($data['NameOf']) : '';
        isset($data['PaymentMethodRef']) ? $obj->setPaymentMethodRef($data['PaymentMethodRef']) : '';
        isset($data['PaymentRefNum']) ? $obj->setPaymentRefNum($data['PaymentRefNum']) : '';
        isset($data['PaymentType']) ? $obj->setPaymentType($data['PaymentType']) : '';
        isset($data['PayType']) ? $obj->setPayType($data['PayType']) : '';
        isset($data['POStatus']) ? $obj->setPOStatus($data['POStatus']) : '';
        ...
        isset($data['StartTime']) ? $obj->setStartTime($data['StartTime']) : '';
        isset($data['Taxable']) ? $obj->setTaxable($data['Taxable']) : '';
        isset($data['ToAccountRef']) ? $obj->setToAccountRef($data['ToAccountRef']) : '';
